        ...
        <div class="row featured__filter">
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 mix oranges fresh-meat">
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="product/{{ $tproducts->image }}">
                    </div>
                    <div class="featured__item__text">
                        <h6><a href="{{ url('/product_details', $tproducts->id) }}">{{ $tproducts->title }}</a></h6>
                        <h5>#{{ $tproducts->price }}</h5>
                    </div>
                </div>
            </div>
